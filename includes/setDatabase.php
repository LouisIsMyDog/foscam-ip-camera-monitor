...
class setDatabase {
	...
	private function insert_admin() {
		global $db, $admin_user, $admin_password, $admin_firstname, $admin_lastname;
		$sql  = "INSERT INTO users ";
		$sql .= "(username, password, first_name, last_name ) ";
		$sql .= "VALUES ('".$admin_user."', '".$admin_password."', '".$admin_firstname."', '".$admin_lastname."' );";
		return $db->query($sql) ?  true : false;
	}
	...
	private function set_per() {
		global $group_ids, $permissions, $db;
		$sql = 'SET FOREIGN_KEY_CHECKS=0;';
		if($db->query($sql)): $permissions->set_permissions('1',$group_ids); 
		endif;
	}
